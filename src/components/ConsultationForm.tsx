...
export default function ConsultationForm() {
  ...
  if (submitted) {
    return (
      ...
      >
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-accent-500/20 text-accent-400">
        ...
        <button
          ...
          className="mt-6 rounded-full border border-white/15 px-6 py-2.5 text-sm font-semibold transition-colors hover:bg-white/5"
        >
          ارسال درخواست جدید
        </button>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="mt-6 w-full rounded-full bg-accent-500 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-accent-500/25 transition-colors hover:bg-accent-600 sm:w-auto sm:text-base"
      >
        ارسال درخواست
      </button>
    </form>
