# Graph Report - website  (2026-08-22)

## Corpus Check
- 522 files · ~556,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5796 nodes · 12289 edges · 335 communities (240 shown, 95 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.62)
...
6. `runHook()` - 40 edges
7. `collectBrowserFindings()` - 37 edges
8. `useToast()` - 37 edges
...
## Communities (335 total, 95 thin omitted)

### Community 0 - "formatJalali"
Cohesion: 0.06
Nodes (58): RFC-5987, ContractCardMobile(), ContractRowDesktop(), ContractWithUser, Props, PLACEHOLDER_ROWS, AdminContractsPage(), buildOrderBy() (+50 more)
...
Cohesion: 0.06
Nodes (41): BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, dynamic, metadata, dynamic, metadata (+33 more)
...
### Community 8 - "auth.ts"
Cohesion: 0.04
Nodes (41): dynamic, dynamic, dynamic, metadata, dynamic, dynamic, dynamic, POST() (+33 more)
...
Cohesion: 0.13
Nodes (21): metadata, ConsultationSection(), Customers(), SEGMENTS, Features, APPROACH, PLANS, PricingArchived() (+13 more)
...
Cohesion: 0.04
Nodes (49): dynamic, dynamic, metadata, BlogPostPage(), generateMetadata(), getPost(), revalidate, metadata (+41 more)
...
### Community 40 - "checkHtmlPatterns"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (38): dynamic, metadata, PATCH(), PATCH(), POST(), ensureUniqueSlug(), PATCH(), ensureUniqueSlug() (+30 more)
...
Cohesion: 0.21
Nodes (9): AuthNavLink(), AuthNavLinkProps, Button, ButtonProps, buttonVariants, Header(), MenuToggleIcon(), MenuToggleProps (+1 more)

### Community 57 - "logger.ts"
Cohesion: 0.13
Nodes (25): AdminLogsPage(), dynamic, metadata, GET(), PATCH(), GET(), ACTION_LABELS_FA, enforceRetention() (+17 more)

### Community 58 - "SiteContentForm.tsx"
Cohesion: 0.18
...
Cohesion: 0.06
Nodes (52): AdminContractDetailPage(), dynamic, dynamic, metadata, ContractFileUploadField(), ContractFileUploadFieldProps, ContractForm(), ContractFormProps (+44 more)

### Community 85 - "TicketChatSkeleton.tsx"
Cohesion: 0.28
Nodes (3): JUSTIFY_CLASS, ROWS, TicketChatSkeleton()

### Community 86 - "TicketChat.tsx"
Cohesion: 0.14
Nodes (12): CannedResponse, CannedResponsePicker(), EmojiPicker(), Picker, BubbleProps, ChatAttachment, formatFileSize(), isImageMime() (+4 more)
...
### Community 133 - "syncEditBadgeHitProxies"
Cohesion: 0.27
...
### Community 158 - "cn"
Cohesion: 0.21
Nodes (11): AccountSidebarProps, ADMIN_LINKS, EXACT_MATCH_HREFS, isLinkActive(), NavItem(), PERSONAL_LINKS, SidebarContents(), Avatar() (+3 more)
...
### Community 170 - "app/blog/page.tsx"
Cohesion: 0.24
...
### Community 175 - "orders/new/page.tsx"
Cohesion: 0.22
Nodes (7): dynamic, metadata, Customer, Item, OrderForm(), OrderFormProps, STATUS_OPTIONS

### Community 176 - "ProductCategories.tsx"
Cohesion: 0.24
Nodes (7): metadata, AuxiliaryServices(), SERVICES, Condition, CONDITION_BADGE, ProductCategories(), ProductCategoriesProps
...
Cohesion: 0.13
Nodes (20): AdminContentPage(), dynamic, RootLayout(), Home(), ProductsPage(), FooterContactForm(), HeroProps, DEFAULT_FOOTER_CONTACT (+12 more)
...
### Community 339 - "provider.mjs"
Cohesion: 0.50
Nodes (3): IMPECCABLE_COMMAND, IMPECCABLE_COMMAND_PREFIX, IMPECCABLE_PROVIDER_ID

## Knowledge Gaps
- **1301 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1296 more)
...
- **Why does `loadContext()` connect `context-signals.mjs` to `doctor.mjs`, `hook-before-edit.mjs`, `live-server.mjs`, `surface-briefs.mjs`, `context.mjs`, `hook-lib.mjs`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `readLiveServerInfo()` connect `impeccable-paths.mjs` to `live.mjs`, `live-server.mjs`, `live-status.mjs`, `live-poll.mjs`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `useToast()` connect `useToast` to `status-labels.ts`, `orders/new/page.tsx`, `sanitizePlainText`, `jalali.ts`, `TicketChat.tsx`, `SiteContentForm.tsx`?**
