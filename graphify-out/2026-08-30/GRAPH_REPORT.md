...
## Corpus Check
- 562 files · ~622,283 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6485 nodes · 13264 edges · 405 communities (309 shown, 96 thin omitted)
...
## Communities (405 total, 96 thin omitted)
...
### Community 2 - "TicketListItem.tsx"
Cohesion: 0.40
Nodes (3): PLACEHOLDER_ROWS, Ticket, TicketListItem()
...
Cohesion: 0.08
Nodes (44): AdminLogFileDetailPage(), dynamic, formatSize(), metadata, GET(), isLogCategory(), PATCH(), CategoryBadge() (+36 more)

### Community 58 - "ToastProvider.tsx"
Cohesion: 0.05
Nodes (52): AdminContractDetailPage(), dynamic, AccountContractsPage(), dynamic, AvatarUploader(), AvatarUploaderProps, BlogPostForm(), BlogPostFormProps (+44 more)
...
Cohesion: 0.11
Nodes (28): dynamic, metadata, PendingCustomersPage(), CustomerApprovalActions(), DateInput(), DateInputProps, daysInGregorianMonth(), GREGORIAN_MONTHS (+20 more)
...
Cohesion: 0.06
Nodes (38): dynamic, metadata, dynamic, PATCH(), POST(), POST(), POST(), POST() (+30 more)
...
Cohesion: 0.07
Nodes (28): dynamic, dynamic, CannedResponse, CannedResponsePicker(), DeletePostButton(), ALWAYS_LOCKED_BY_DEFAULT, dateOnlyKey(), dateTimeKeyFromFilename() (+20 more)
...
Cohesion: 0.06
Nodes (32): BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, dynamic, dynamic, metadata, AdminOrderDetailPage() (+24 more)
...
### Community 271 - "tickets/new/page.tsx"
Cohesion: 0.40
...
- **Why does `readLiveServerInfo()` connect `live-status.mjs` to `impeccable-paths.mjs`, `live.mjs`, `live-server.mjs`, `source-lock.mjs`, `live-poll.mjs`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `prisma` connect `auth.ts` to `status-labels.ts`, `logEvent`, `events.ts`, `[slug]/page.tsx`, `ThemedGridBackdrop.tsx`, `useToast`, `TicketChat.tsx`, `formatNumber`, `jalali.ts`, `upload/route.ts`, `ToastProvider.tsx`, `DashboardCharts.tsx`, `site-content.ts`?**
