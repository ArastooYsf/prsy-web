/**
 * ARCHIVED — three-tier pricing card display, taken out of use because the
 * site no longer shows numeric prices anywhere (everything routes to
 * /consultation instead). Not imported by anything; kept only for
 * reference in case tiered pricing cards are needed again later.
 *
 * To reactivate: rename this file to Pricing.tsx (replacing the current
 * no-price version) or copy its contents back into Pricing.tsx.
 */
