# Graph Report - website  (2026-08-29)

## Corpus Check
- 562 files · ~622,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6473 nodes · 13248 edges · 405 communities (310 shown, 95 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e24b6788`
...
## Communities (405 total, 95 thin omitted)

### Community 0 - "status-labels.ts"
Cohesion: 0.06
Nodes (63): RFC-5987, ContractCardMobile(), ContractRowDesktop(), ContractWithUser, Props, PLACEHOLDER_ROWS, AdminContractsPage(), buildOrderBy() (+55 more)
...
Cohesion: 0.17
Nodes (22): sendEmail(), logDelivery(), notifyContractExpiry(), notifyOrderStatusChange(), notifyStaffNewCustomerMessage(), notifyTicketReply(), SYSTEM_ACTOR, TicketRef (+14 more)
...
### Community 8 - "auth.ts"
Cohesion: 0.04
Nodes (52): main(), dynamic, dynamic, metadata, PATCH(), POST(), POST(), POST() (+44 more)

### Community 9 - "card"
Cohesion: 0.20
Nodes (12): $type, $value, bg, bg, padding, shadow, card, bg (+4 more)

### Community 10 - "[slug]/page.tsx"
Cohesion: 0.21
...
Cohesion: 0.08
Nodes (32): metadata, metadata, About(), AboutProps, PRINCIPLES, SERVICES, ConsultationSection(), Counter() (+24 more)
...
### Community 44 - "ThemedGridBackdrop.tsx"
Cohesion: 0.12
Nodes (14): BlogPost, BlogPostCard(), PLACEHOLDER_CARDS, BlogPage(), getPosts(), metadata, revalidate, CONTACT_ITEMS (+6 more)
...
### Community 49 - "renderGroupedTemplate"
Cohesion: 0.29
...
### Community 58 - "TicketChat.tsx"
Cohesion: 0.05
Nodes (46): AdminContractDetailPage(), dynamic, dynamic, AccountContractsPage(), dynamic, dynamic, CannedResponse, CannedResponsePicker() (+38 more)
...
Cohesion: 0.09
Nodes (28): dynamic, metadata, ContractForm(), ContractFormProps, Customer, Calendar, DateInput(), DateInputProps (+20 more)
...
### Community 94 - "SiteContentForm.tsx"
Cohesion: 0.14
Nodes (20): IconPicker(), IconPickerProps, CONDITION_OPTIONS, emptyCategory(), emptySlide(), genId(), SiteContentForm(), SiteContentFormProps (+12 more)
...
### Community 98 - "syncEditBadgeHitProxies"
Cohesion: 0.27
...
Cohesion: 0.04
Nodes (48): dynamic, metadata, dynamic, metadata, dynamic, dynamic, metadata, PATCH() (+40 more)
...
### Community 112 - "LogsExplorer.tsx"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (52): applyStaticDeclaration(), buildBorderOverrideMap(), parseShorthand(), buildStaticStyleMap(), buildStaticWindow(), collectStaticCssRules(), collectStaticCssText(), compareStaticPriority() (+44 more)
...
Cohesion: 0.12
Nodes (34): confirm(), detectCli(), detectLocalFile(), dim(), fileUrlToLocalPath(), formatAdvisorySection(), formatFindings(), formatFindingsBody() (+26 more)

### Community 153 - "normalizeGitHubEvent"
Cohesion: 0.47
Nodes (6): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs()

### Community 155 - "live-status.mjs"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (43): applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns(), rel(), renderText(), safeRead() (+35 more)
...
### Community 177 - "formatNumber"
Cohesion: 0.07
Nodes (32): BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, dynamic, dynamic, metadata, PendingCustomersPage() (+24 more)
...
### Community 179 - "getMediaUrl"
Cohesion: 0.15
Nodes (13): AvatarUploader(), AvatarUploaderProps, BlogPostForm(), BlogPostFormProps, MediaPicker(), MediaPickerProps, RichTextEditor(), RichTextEditorProps (+5 more)
...
### Community 215 - "cn"
Cohesion: 0.09
Nodes (30): SimpleRichTextEditor(), SimpleRichTextEditorProps, AuthNavLink(), AuthNavLinkProps, RouteThemeScope(), SiteTheme, SiteThemeContext, SiteThemeContextValue (+22 more)
...
Cohesion: 0.14
Nodes (18): AdminContentPage(), dynamic, RootLayout(), Home(), metadata, ProductsPage(), FooterContactForm(), AuxiliaryServices() (+10 more)
...
### Community 227 - "twofactor.ts"
Cohesion: 0.33
Nodes (6): POST(), POST(), POST(), createTwoFactorSecret(), twoFactorQrCodeDataUrl(), verifyTwoFactorCode()

### Community 228 - "checkHtmlPatterns"
Cohesion: 0.15
Nodes (17): buildHtmlPatternCorpora(), checkHtmlPatterns(), collectMarqueeKeyframes(), collectPulseKeyframes(), cssLengthToPx(), enclosingCssSelector(), indexInSourceRanges(), infiniteAnimationNames() (+9 more)
...
### Community 233 - "critique-storage.mjs"
Cohesion: 0.15
...
### Community 235 - "orders/new/page.tsx"
Cohesion: 0.22
...
### Community 255 - "logs/export/route.ts"
Cohesion: 0.18
...
### Community 264 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
...
### Community 269 - "ErrorPageShell.tsx"
Cohesion: 0.15
...
### Community 275 - "app/layout.tsx"
Cohesion: 0.18
Nodes (8): metadata, vazirmatn, viewport, CookieConsentBanner(), PageLoader(), PageViewTracker(), SessionProviderWrapper(), ScrollProgress()
...
### Community 284 - "NotificationBell.tsx"
Cohesion: 0.33
...
### Community 322 - "Impeccable Documenter"
Cohesion: 0.40
...
### Community 347 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
### Community 350 - "primary-foreground"
Cohesion: 0.67
...
## Knowledge Gaps
- **1793 isolated node(s):** `PLACEHOLDER_ROWS`, `dynamic`, `SORT_FIELDS`, `ContractRow`, `columns` (+1788 more)
...
- **Why does `authOptions` connect `auth.ts` to `status-labels.ts`, `upload/route.ts`, `account/tickets/page.tsx`, `twofactor.ts`, `logs/export/route.ts`, `[slug]/page.tsx`, `orders/new/page.tsx`, `ThemedGridBackdrop.tsx`, `useToast`, `logs/page.tsx`, `formatNumber`, `getMediaUrl`, `jalali.ts`, `logger.ts`, `TicketChat.tsx`, `admin/page.tsx`, `site-content.ts`, `AccountShell.tsx`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `prisma` connect `auth.ts` to `status-labels.ts`, `account/tickets/page.tsx`, `twofactor.ts`, `events.ts`, `[slug]/page.tsx`, `orders/new/page.tsx`, `ThemedGridBackdrop.tsx`, `useToast`, `formatNumber`, `jalali.ts`, `upload/route.ts`, `TicketChat.tsx`, `admin/page.tsx`, `site-content.ts`?**
...
- **What connects `PLACEHOLDER_ROWS`, `dynamic`, `SORT_FIELDS` to the rest of the system?**
