...
## Communities (375 total, 71 thin omitted)

### Community 0 - "lucide-react"
Cohesion: 0.04
Nodes (93): RFC-5987, lucide-react, react-loading-skeleton, dynamic, ContractCardMobile(), ContractRowDesktop(), ContractWithUser, Props (+85 more)
...
Cohesion: 0.07
Nodes (39): dynamic, metadata, CategoryCatalogPage(), dynamic, generateMetadata(), loadCategory(), Breadcrumb(), Crumb (+31 more)
...
### Community 8 - "auth.ts"
Cohesion: 0.04
Nodes (53): bcryptjs, next-auth, dynamic, dynamic, metadata, dynamic, dynamic, dynamic (+45 more)
...
Cohesion: 0.15
Nodes (21): getChartData(), GET(), VALID_RANGES, GET(), VALID_RANGES, GET(), getContractOrderTrend(), getOrderStatusBreakdown() (+13 more)

### Community 28 - "framer-motion"
Cohesion: 0.08
Nodes (37): framer-motion, metadata, metadata, Home(), About(), AboutProps, PRINCIPLES, SERVICES (+29 more)
...
### Community 56 - "Responsive Design"
Cohesion: 0.20
Nodes (10): Breakpoints: Content-Driven, Detect Input Method, Not Just Screen Size, Layout Adaptation Patterns, Mobile-First: Write It Right, Picture Element for Art Direction, Responsive Design, Responsive Images: Get It Right, Safe Areas: Handle the Notch (+2 more)

### Community 57 - "logger.ts"
Cohesion: 0.11
Nodes (31): GET(), isLogCategory(), PATCH(), createEncryptedLogExportZip(), EncryptedLogExportZip, resolveExportPassword(), ALL_LOG_CATEGORIES, ACTION_DEFAULT_CATEGORY (+23 more)

### Community 58 - "RichTextEditor.tsx"
Cohesion: 0.18
Nodes (5): @tiptap/extension-image, @tiptap/react, @tiptap/starter-kit, RichTextEditorProps, SimpleRichTextEditorProps
...
Cohesion: 0.08
Nodes (34): jalaali-js, dynamic, metadata, dynamic, metadata, PendingCustomersPage(), ContractForm(), ContractFormProps (+26 more)
...
Cohesion: 0.04
Nodes (58): @radix-ui/react-popover, BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, CARDS, AdminLogFileDetailPage(), dynamic (+50 more)

### Community 95 - "filterFindings"
Cohesion: 0.23
...
### Community 98 - "lighthouse.ts"
Cohesion: 0.27
Nodes (8): POST(), execFileAsync, getLighthouseHistory(), HISTORY_FILE, LIGHTHOUSE_DIR, LighthouseReport, LighthouseRun, runLighthouseAudit()
...
Cohesion: 0.09
Nodes (43): @radix-ui/react-accordion, @radix-ui/react-tabs, EditProductPage(), PATCH(), POST(), ensureUniqueSlug(), PATCH(), ensureUniqueSlug() (+35 more)
...
### Community 132 - "DashboardCharts.tsx"
Cohesion: 0.12
Nodes (20): recharts, axisTick, ChartCard(), ORDER_STATUS_COLORS, OrderStatusChart(), RangeFilter(), TICKET_STATUS_COLORS, TicketStatusChart() (+12 more)
...
### Community 158 - "next"
Cohesion: 0.09
Nodes (18): next, dynamic, metadata, dynamic, firstParam(), metadata, NewTicketPage(), BlogPost (+10 more)
...
### Community 161 - "contact/page.tsx"
Cohesion: 0.40
...
### Community 177 - "react"
Cohesion: 0.05
Nodes (52): react, dynamic, PATCH(), POST(), POST(), NewTicketForm(), NOTIFICATION_OPTIONS, NotificationSettingsPreview() (+44 more)
...
Cohesion: 0.05
Nodes (38): name, private, version, class-variance-authority, clsx, emoji-mart, @emoji-mart/data, @emoji-mart/react (+30 more)
...
### Community 215 - "cn"
Cohesion: 0.07
Nodes (44): RichTextEditor(), SimpleRichTextEditor(), AuthNavLink(), AuthNavLinkProps, RouteThemeScope(), SiteTheme, SiteThemeContext, SiteThemeContextValue (+36 more)
...
Cohesion: 0.12
Nodes (20): AdminContentPage(), dynamic, cleanText(), cleanUrl(), POST(), cleanHeroSlide(), POST(), FooterContactForm() (+12 more)
...
Cohesion: 0.10
Nodes (19): AccountShell(), AccountShellProps, isBareShellRoute(), AccountSidebar(), AccountSidebarProps, ADMIN_LINKS, EXACT_MATCH_HREFS, isLinkActive() (+11 more)
...
### Community 226 - "Operate mode depth (and Read notes)"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (51): @radix-ui/react-dialog, AdminContractDetailPage(), dynamic, firstImage(), priceLabel(), ProductCardMobile(), ProductListItem, ProductRowDesktop() (+43 more)
...
### Community 235 - "ErrorPageShell.tsx"
Cohesion: 0.08
Nodes (16): nextConfig, @sentry/nextjs, beforeSend(), SYSTEM_ACTOR, metadata, metadata, ErrorPageShell(), ErrorPageShellProps (+8 more)
...
### Community 245 - "inline-ignores.mjs"
Cohesion: 0.40
...
### Community 255 - "logs/page.tsx"
Cohesion: 0.15
Nodes (18): AdminLogsPage(), dynamic, metadata, summarizeCategoryTrend(), listLogFiles(), classifySegmentStatus(), computeUptimePercent(), DailyUptimeSegment (+10 more)
...
### Community 262 - "LogsDashboard.tsx"
Cohesion: 0.12
Nodes (18): CategoryStatCard(), formatDurationFa(), formatUptimePercent(), LogsDashboardProps, SEGMENT_STATUS_CLASS, segmentTooltipText(), SpeedTestCard(), UptimeCard() (+10 more)
...
### Community 267 - "admin/orders/[id]/page.tsx"
Cohesion: 0.15
Nodes (12): AdminOrderDetailPage(), dynamic, dynamic, metadata, Customer, Item, OrderForm(), OrderFormProps (+4 more)
...
Cohesion: 0.11
Nodes (16): metadata, RootLayout(), shabnamFD, vazirmatn, viewport, metadata, ProductsPage(), AuxiliaryServices() (+8 more)
...
### Community 404 - "HeaderSearch.tsx"
Cohesion: 0.33
Nodes (5): CLOSE_TRANSITION, OPEN_TRANSITION, POPULAR_SEARCHES, SearchDropdownBanner(), SearchDropdownBannerProps

### Community 405 - "provider.mjs"
Cohesion: 0.50
...
## Knowledge Gaps
- **1921 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1916 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2445 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **71 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `lucide-react` connect `lucide-react` to `CatalogView.tsx`, `DashboardCharts.tsx`, `LogsDashboard.tsx`, `auth.ts`, `log-types.ts`, `admin/orders/[id]/page.tsx`, `ProductForm.tsx`, `HeaderSearch.tsx`, `framer-motion`, `react`, `package.json`, `jalali.ts`, `cn`, `site-content.ts`, `formatNumber`, `AccountSidebar.tsx`, `getMediaUrl`, `sanitizePlainText`, `app/layout.tsx`, `logs/page.tsx`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `lucide-react`, `DashboardCharts.tsx`, `LogsDashboard.tsx`, `log-types.ts`, `admin/orders/[id]/page.tsx`, `ProductForm.tsx`, `HeaderSearch.tsx`, `framer-motion`, `next`, `package.json`, `RichTextEditor.tsx`, `jalali.ts`, `cn`, `site-content.ts`, `formatNumber`, `AccountSidebar.tsx`, `getMediaUrl`, `ErrorPageShell.tsx`, `sanitizePlainText`, `app/layout.tsx`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `next` connect `next` to `contact/page.tsx`, `app/layout.tsx`, `getMediaUrl`, `CatalogView.tsx`, `Project README`, `privacy/page.tsx`, `auth.ts`, `terms/page.tsx`, `warranty/page.tsx`, `admin/orders/[id]/page.tsx`, `ErrorPageShell.tsx`, `sanitizePlainText`, `jalali.ts`, `package.json`, `framer-motion`, `formatNumber`, `logs/page.tsx`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `fs`, `path`, `fs` to the rest of the system?**
  _1921 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `lucide-react` be split into smaller, more focused modules?**
  _Cohesion score 0.04283435862383231 - nodes in this community are weakly interconnected._
