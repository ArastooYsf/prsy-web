...
## Corpus Check
- 541 files · ~606,886 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6324 nodes · 12809 edges · 395 communities (300 shown, 95 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0347acf2`
...
Cohesion: 0.06
Nodes (65): RFC-5987, ContractCardMobile(), ContractRowDesktop(), ContractWithUser, Props, PLACEHOLDER_ROWS, AdminContractsPage(), buildOrderBy() (+57 more)
...
Cohesion: 0.07
Nodes (23): dynamic, metadata, PendingCustomersPage(), dynamic, dynamic, CannedResponse, CannedResponsePicker(), CustomerApprovalActions() (+15 more)
...
### Community 8 - "auth.ts"
Cohesion: 0.04
Nodes (41): dynamic, dynamic, metadata, dynamic, PLACEHOLDER_ROWS, dynamic, Ticket, TicketListItem() (+33 more)
...
Cohesion: 0.05
Nodes (57): BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, dynamic, CARDS, AdminOrderDetailPage(), dynamic (+49 more)
...
Cohesion: 0.05
Nodes (46): AdminContractDetailPage(), dynamic, AccountContractsPage(), dynamic, BlogPost, BlogPostCard(), PLACEHOLDER_CARDS, BlogPage() (+38 more)
...
Cohesion: 0.04
Nodes (41): dynamic, metadata, dynamic, metadata, dynamic, metadata, dynamic, dynamic (+33 more)
...
Cohesion: 0.09
Nodes (34): PATCH(), PATCH(), POST(), ensureUniqueSlug(), PATCH(), ensureUniqueSlug(), POST(), POST() (+26 more)
...
### Community 87 - "cn"
Cohesion: 0.06
Nodes (37): dynamic, metadata, AccountShell(), AccountShellProps, isBareShellRoute(), AccountSidebar(), AccountSidebarProps, ADMIN_LINKS (+29 more)
...
### Community 176 - "browser-script-parts.mjs"
Cohesion: 0.19
...
### Community 179 - "instructions.mjs"
Cohesion: 0.40
...
### Community 215 - "readLiveServerInfo"
Cohesion: 0.39
...
### Community 250 - "manual-edits-buffer.mjs"
Cohesion: 0.19
...
### Community 267 - "manual-edit-routes.mjs"
Cohesion: 0.57
...
Cohesion: 0.20
Nodes (11): IMPECCABLE_DIR, extensionCache, LIVE_TEMPLATE_EXTENSIONS, matchesTemplateExtension(), normalizeExtensionEntries(), readLiveTemplateExtensions(), resolveLiveTemplateExtensions(), safeReadJson() (+3 more)
...
### Community 336 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
## Knowledge Gaps
- **1749 isolated node(s):** `Overview`, `Primary`, `Secondary`, `Neutral`, `Named Rules` (+1744 more)
...
- **Why does `prisma` connect `auth.ts` to `status-labels.ts`, `TicketChat.tsx`, `events.ts`, `site-content.ts`, `useToast`, `jalali.ts`, `sanitizePlainText`, `upload/route.ts`, `formatNumber`, `getMediaUrl`?**
...
- **Why does `enterLiveRoot()` connect `roots.mjs` to `live-server.mjs`, `live-wrap.mjs`, `live-inject.mjs`, `live-accept.mjs`, `live-poll.mjs`, `readLiveServerInfo`, `live-status.mjs`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
