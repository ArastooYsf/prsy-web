...
import { SITE_CONTENT_TAG, CUSTOMERS_KEY, type CustomersContent } from "@/lib/site-content";
...
export async function POST(request: Request) {
  ...
  await prisma.siteContent.upsert({
    where: { key: CUSTOMERS_KEY },
    update: { value: JSON.stringify(content) },
    create: { key: CUSTOMERS_KEY, value: JSON.stringify(content) },
  });
