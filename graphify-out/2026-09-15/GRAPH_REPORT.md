...
1. `next-auth` - 102 edges
2. `prisma` - 102 edges
3. `authOptions` - 100 edges
4. `lucide-react` - 90 edges
5. `react` - 82 edges
6. `TailwindConfigGenerator` - 58 edges
7. `cn()` - 57 edges
8. `useToast()` - 53 edges
9. `formatNumber()` - 50 edges
...
### Community 0 - "formatJalali"
Cohesion: 0.06
Nodes (72): RFC-5987, AdminBlogListPage(), dynamic, ContractCardMobile(), ContractRowDesktop(), PLACEHOLDER_ROWS, AdminContractsPage(), buildOrderBy() (+64 more)
...
Cohesion: 0.08
Nodes (37): CategoryCatalogPage(), dynamic, generateMetadata(), loadCategory(), CatalogSortSelect(), SORT_LABELS, CatalogCategory, CatalogView() (+29 more)
...
Cohesion: 0.12
Nodes (29): main(), POST(), POST(), sendEmail(), logDelivery(), notifyContractExpiry(), notifyOrderStatusChange(), notifyStaffNewCustomerMessage() (+21 more)
...
### Community 8 - "auth.ts"
Cohesion: 0.04
Nodes (52): bcryptjs, next-auth, dynamic, dynamic, metadata, dynamic, dynamic, dynamic (+44 more)
...
### Community 27 - "[productSlug]/page.tsx"
Cohesion: 0.07
Nodes (57): dynamic, EditProductPage(), POST(), PATCH(), POST(), ensureUniqueSlug(), PATCH(), ensureUniqueSlug() (+49 more)

### Community 28 - "framer-motion"
Cohesion: 0.07
Nodes (38): @emoji-mart/data, framer-motion, @phosphor-icons/react, metadata, metadata, About(), AboutProps, PRINCIPLES (+30 more)
...
Cohesion: 0.10
Nodes (36): AdminLogFileDetailPage(), dynamic, formatSize(), metadata, GET(), isLogCategory(), CategoryBadge(), execFileAsync (+28 more)

### Community 58 - "useToast"
Cohesion: 0.05
Nodes (40): dynamic, metadata, PATCH(), POST(), NewTicketForm(), PasswordForm(), ProfileForm(), ProfileFormProps (+32 more)
...
Cohesion: 0.05
Nodes (40): dependencies, bcryptjs, class-variance-authority, clsx, emoji-mart, @emoji-mart/data, @emoji-mart/react, exceljs (+32 more)
...
### Community 85 - "ErrorPageShell.tsx"
Cohesion: 0.12
...
Cohesion: 0.22
Nodes (11): ADMIN_ONLY_SCOPES, MediaScope, POST(), VALID_SCOPES, ALLOWED_IMAGE_EXTENSIONS, ALLOWED_IMAGE_TYPES, isPdf(), isZipContainer() (+3 more)
...
Cohesion: 0.15
Nodes (22): recharts, axisTick, ChartCard(), ORDER_STATUS_COLORS, OrderStatusChart(), RangeFilter(), TICKET_STATUS_COLORS, TicketStatusChart() (+14 more)
...
### Community 98 - "admin/page.tsx"
Cohesion: 0.11
Nodes (23): CARDS, AdminDashboardPage(), getAdminStats(), getChartData(), getSupportStats(), Props, StatCard(), GET() (+15 more)
...
### Community 103 - "logs/page.tsx"
Cohesion: 0.20
Nodes (13): AdminLogsPage(), dynamic, metadata, GET(), LogsDashboard(), CategoryEventStats, CategoryTrendPoint, getLogEventTrend() (+5 more)
...
Cohesion: 0.05
Nodes (54): react-loading-skeleton, BlogCardMobile(), BlogPost, BlogRowDesktop(), PLACEHOLDER_ROWS, ContractWithUser, Props, dynamic (+46 more)
...
### Community 110 - "CatalogFilterPanel.tsx"
Cohesion: 0.23
...
### Community 134 - "CategoryManager.tsx"
Cohesion: 0.19
Nodes (13): CategoryManager(), Draft, parsePreviewSpecKeys(), CATEGORY_ICON_LABELS, CATEGORY_ICONS, CategoryIconKey, CategoryForTemplate, findRootCategory() (+5 more)
...
### Community 149 - "lighthouse.ts"
Cohesion: 0.31
Nodes (7): POST(), getLighthouseHistory(), HISTORY_FILE, LIGHTHOUSE_DIR, LighthouseReport, LighthouseRun, runLighthouseAudit()
...
### Community 154 - "log-types.ts"
Cohesion: 0.15
Nodes (17): CATEGORY_META, LogCategoryMeta, EXTRA_KEY_LABELS, formatTime(), KNOWN_KEYS, LogFileDetail(), LogFileDetailProps, timeOfDay() (+9 more)
...
Cohesion: 0.12
Nodes (17): CategoryStatCard(), formatDurationFa(), formatUptimePercent(), LogsDashboardProps, SEGMENT_STATUS_CLASS, segmentTooltipText(), SpeedTestCard(), UptimeCard() (+9 more)
...
### Community 160 - "TicketChat.tsx"
Cohesion: 0.06
Nodes (50): @radix-ui/react-dialog, AdminContractDetailPage(), AdminCustomerDetailPage(), dynamic, AccountContractsPage(), cancelContractTicketHref(), newContractTicketHref(), AccountFilesPage() (+42 more)
...
### Community 162 - "TicketChatSkeleton.tsx"
Cohesion: 0.28
...
### Community 165 - "uptime.ts"
Cohesion: 0.20
Nodes (13): isoDay(), classifySegmentStatus(), computeUptimePercent(), DailyUptimeSegment, getUptimeSegments(), globalForUptime, HEARTBEAT_FILE, PROCESS_STARTED_AT (+5 more)
...
Cohesion: 0.06
Nodes (35): name, private, version, class-variance-authority, clsx, emoji-mart, @emoji-mart/react, eslint (+27 more)
...
### Community 215 - "cn"
Cohesion: 0.06
Nodes (49): @tiptap/react, @tiptap/starter-kit, BlogPostForm(), BlogPostFormProps, BrandOption, CategoryOption, ProductFormProps, RichTextEditor() (+41 more)
...
Cohesion: 0.08
Nodes (25): @radix-ui/react-popover, AccountShell(), AccountShellProps, isBareShellRoute(), AccountSidebar(), AccountSidebarProps, ADMIN_LINKS, EXACT_MATCH_HREFS (+17 more)
...
### Community 227 - "product-comments/page.tsx"
Cohesion: 0.33
Nodes (6): AdminProductCommentsPage(), dynamic, isValidStatus(), metadata, STATUS_FILTERS, ProductCommentActions()

### Community 229 - "source-search.mjs"
Cohesion: 0.36
...
### Community 242 - "Adaptation Strategies"
Cohesion: 0.40
...
Cohesion: 0.06
Nodes (49): AdminContentPage(), dynamic, ContactPage(), metadata, FAQPage(), metadata, Home(), metadata (+41 more)

### Community 244 - "ProductTabs.tsx"
Cohesion: 0.40
Nodes (4): @radix-ui/react-accordion, @radix-ui/react-tabs, ProductTabs(), ProductTabSection

### Community 245 - "Diagnostic Scan"
Cohesion: 0.33
...
### Community 254 - "bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 255 - "Impeccable Documenter"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (27): lucide-react, react, firstImage(), priceLabel(), ProductCardMobile(), ProductListItem, ProductRowDesktop(), Thumb() (+19 more)
...
### Community 290 - "next"
Cohesion: 0.04
Nodes (40): next, dynamic, metadata, PendingCustomersPage(), dynamic, metadata, dynamic, metadata (+32 more)
...
Cohesion: 0.14
Nodes (12): metadata, RootLayout(), shabnamFD, vazirmatn, viewport, ProductsPage(), CookieConsentBanner(), PageLoader() (+4 more)
...
## Knowledge Gaps
- **1939 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1934 more)
...
- **Why does `lucide-react` connect `lucide-react` to `formatJalali`, `CatalogView.tsx`, `CategoryManager.tsx`, `auth.ts`, `log-types.ts`, `[productSlug]/page.tsx`, `framer-motion`, `LogsDashboard.tsx`, `TicketChat.tsx`, `HeaderSearch.tsx`, `next`, `package.json`, `logger.ts`, `useToast`, `LogsExplorer.tsx`, `cn`, `toPersianDigits`, `AccountSidebar.tsx`, `admin/page.tsx`, `product-comments/page.tsx`, `logs/page.tsx`, `status-labels.tsx`, `CatalogFilterPanel.tsx`, `site-content.ts`, `ProductTabs.tsx`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `prisma` connect `auth.ts` to `formatJalali`, `TicketChat.tsx`, `next`, `admin/page.tsx`, `product-comments/page.tsx`, `events.ts`, `HeaderSearch.tsx`, `CatalogView.tsx`, `status-labels.tsx`, `site-content.ts`, `upload/route.ts`, `[productSlug]/page.tsx`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `loadContext()` connect `context-signals.mjs` to `critique-storage.mjs`, `live-server.mjs`, `doctor.mjs`, `context.mjs`, `hook-lib.mjs`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `fs`, `path`, `fs` to the rest of the system?**
  _1939 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `formatJalali` be split into smaller, more focused modules?**
